...
class ProjectNestedSetTest < ActiveSupport::TestCase
  ...
  def setup
    ...
    @a = Project.create!(:name => 'A', :identifier => 'projecta', :typ => Project::TYPES.first)
    @a1 = Project.create!(:name => 'A1', :identifier => 'projecta1', :typ => Project::TYPES.first)
    @a1.set_parent!(@a)
    @a2 = Project.create!(:name => 'A2', :identifier => 'projecta2', :typ => Project::TYPES.first)
    @a2.set_parent!(@a)

    @c = Project.create!(:name => 'C', :identifier => 'projectc', :typ => Project::TYPES.first)
    @c1 = Project.create!(:name => 'C1', :identifier => 'projectc1', :typ => Project::TYPES.first)
    @c1.set_parent!(@c)

    @b = Project.create!(:name => 'B', :identifier => 'projectb', :typ => Project::TYPES.first)
    @b2 = Project.create!(:name => 'B2', :identifier => 'projectb2', :typ => Project::TYPES.first)
    @b2.set_parent!(@b)
    @b1 = Project.create!(:name => 'B1', :identifier => 'projectb1', :typ => Project::TYPES.first)
    @b1.set_parent!(@b)
    @b11 = Project.create!(:name => 'B11', :identifier => 'projectb11', :typ => Project::TYPES.first)
    @b11.set_parent!(@b1)
